        ...
        <div className={styles.aboutParent}>
          <div className={styles.aboutcol1}>
            ...
            <div className={styles.aboutText}>
              ...
              <p>
                vitae nunc sed velit dignissim, consectetur adipiscing elit, sed
                do eiusmod tempor etur adipiscing el incididunt ut labore et
                dolore magna aliqua. Bibendum arcusmod tempor incididunt vitae
